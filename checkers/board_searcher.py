...
class BoardSearcher:
	...
	def get_pieces_in_play(self):
		return self.player_pieces[self.board.player_turn] if self.board.piece_requiring_further_capture_moves is None else [self.board.piece_requiring_further_capture_moves]
